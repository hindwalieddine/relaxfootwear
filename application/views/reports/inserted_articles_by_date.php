<div class="articles-inserted-listing">
 ...
 <div class="noprint">
     <?php echo form_open('/reports/insertedarticlesbydate', array('method'=>'get')) ?>
     <h1 id="title"><?php echo 'Report Of Inserted Articles By Date';?></h1>
    <table>
        <tr>
    ...
    <table cellspacing="0">
       <tr>
            <th width="76"></th>
            <th width="82" align="left">Serie 1</th>
            <th width="37">16</th>
            <th width="37">17</th>
            <th width="37">18</th>
            <th width="37">19</th>
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tr align="center" class="row<?php echo $r ?>">
            ...
            <td width="10"><?php echo anchor('/stocks/edit/'.$row->id, 'Edit') ?></td>
            <td width="10"><?php echo anchor('/stocks/delete/'.$row->id, 'Delete') ?></td>
        </tr>
