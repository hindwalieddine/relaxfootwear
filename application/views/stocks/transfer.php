<h1 id="title">Transfer Article</h1>
<div id="diverror">
...
<?php echo form_open('/stocks/transfer/', 'id="transferForm"') ?>
    <tr>
        <td>
    ...
    <?php echo form_dropdown('to', array(1 => 'Relax', 2 => 'Solderie', 3=> 'Depot')) ?>
	 <label>Date:</label>
...
$('#transferForm').submit(function(e){
	...
	if( $('[name=from]').val() == $('[name=to]').val() ){
		alert("You Can't transfer from the same stock");
		e.preventDefault();
		return false;
	}
